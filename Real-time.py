...
def RealTime(): 
  ...
  while 1:
    ...
    ##BE sPECIFIC FOR THE REPO TO BE SCANED 
      ...
      try:DeepScanning.virusScanner(paths[0])
      except:pass
      paths.clear()
...
#https://www.youtube.com/watch?v=3XVoOEWvbd8&list=PLkzUkNupwT3S-lwWGfG6D5Xs2-hKuxXT2&index=20